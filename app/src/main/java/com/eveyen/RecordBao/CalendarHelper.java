...
public class CalendarHelper {
    ...
    public Intent getIntentAfterSetting(){
        ...
        intent.putExtra(CalendarHelper .EVENT_TITLE, getTitle());
        intent.putExtra(CalendarHelper .EVENT_DESCRIPTION, getDescription());
        intent.putExtra(CalendarHelper .EVENT_BEGIN_TIME, getBeginTimeInMillis());
        intent.putExtra(CalendarHelper .EVENT_END_TIME, getEndTimeInMillis());
        intent.putExtra(CalendarHelper .EVENT_ALL_DAY, isAllDay());
        intent.putExtra(CalendarHelper .EVENT_LOCATION, getLocation());
        return intent;
    }
}